...
public class ListaEnlazada<T> implements Iterable<T> {
    ...
    public int indexOfProducto(DetallePedido elemento) {
        ...
        if (isEmpty()) {
            ...
            while (aux != null) {
            	...
            	DetallePedido dp=DetallePedido.class.cast(primero.getElemento());
                if (elemento.getProducto().equals(dp.getProducto())) { //Mejor .equals que ==
    ...
    private class MiIterador<ListaDinamica> implements Iterator<T> , Iterable<T>{
